...
import {createRouteAnalyticsSection} from '@/analytics/route-analytics';
...
export function renderDataAnalyticsPanel(tab: TabDefinition): HTMLElement {
    ...
    <div class="card analytics-card">
      ...
      <section class="analytics-content" data-role="content" hidden>
        ...
        <div data-role="route-analytics-host"></div>
  ...
  `;
    ...
    const routeAnalyticsHost = panel.querySelector<HTMLElement>('[data-role="route-analytics-host"]')!;
    ...
    const routeAnalyticsSection = createRouteAnalyticsSection();
    routeAnalyticsHost.appendChild(routeAnalyticsSection.element);
    ...
    const renderAll = async () => {
        ...
        // 路線分析（比較表 + 三張圖）
        routeAnalyticsSection.setRows(filteredRows);
